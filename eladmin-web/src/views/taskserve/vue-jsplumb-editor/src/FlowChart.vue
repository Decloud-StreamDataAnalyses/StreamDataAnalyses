                ...
                <div>
                  <div v-show="toolBarShow==='component'">
                    <div v-show="!isShowNode">
                      <div class="title" style="font-size: 16px;font-weight:bold">服务实例属性</div>
                      <div class="model-attr">
                        ...
                        <p>
                          <span class="item" style="font-size: 14px;font-weight: 500">服务名称</span>
                          <el-input size="small"
                                    v-model="modelName" id = "taskname"></el-input>
                        </p>
                        <p>
                          <span class="item" style="font-size: 14px;font-weight: 500">描述</span>
                          <el-input type="textarea"
                                    size="small"
                                    v-model="modelDescription"></el-input>
                        </p>
                        <p>
                          <span class="item" style="font-size: 14px;font-weight: 500">创建日期</span>
                          <span class="value" style="font-size: 14px;font-weight: 500">{{dateFormat()}}</span>
                        </p>
                      </div>
                    </div>
                    <!--
                    <div v-show="isShowNode">
                      ...
                      <div  class="node-attr">
                        <p>
                          ...
                          <el-input size="small" v-model="changeProperty">{{currentNodeId}}</el-input>
                          <span class="value">{{currentNodeId}}</span>
                        </p>
                      </div>
                    </div>
                    -->
                    <div v-show="isShowNode" v-for="(value,key,index) in propertyDict">
                        <p>
                           <span class="item">{{key}}</span>
                           <el-input  v-model="propertyDict[key]"  prop="key">{{value}}</el-input>
                        </p>
                    </div>
...
export default {
  ...
  init(){
     console.log('init flowchart vue')
  },
  watch: {
    filterText(val) {
    ...
    changeProperty(val){
       console.log('changeProperty:',  val)
       console.log('model data:', FlowChart.getModel())
    },
  },
  mounted() {
    ...
    FlowChart.on('selectNode', (id) => {
        this.isShowNode = true;
        console.log('id:', id);
        this.currentNodeId = id;
        console.log('the node data:', this.model.getNodeDataByNodeId(id));
        this.propertyDict = this.model.getNodeDataByNodeId(id)['properties'];
    });
    API.getFlowChartData().then((data) => {
       console.log('getFlowChartData:', data)
